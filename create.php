...
<?php if (isset($_SESSION['logged'])) : ?>
    <section class="container" id="upper">
        ...
        <form class="form" action="php/addEvent.php" method="post">
            ...
            <div class="form__group">
                ...
                <input id="number" class="form__input" type="number" name="event_number_of_members">
            </div>
            <div class="form__group">
                <label class="form__label">Address
                    ...
                    <input id="post_code" class="form__input" type="text" name="event_post_code"
                           pattern="[0-9]{2}\-[0-9]{3}" placeholder="11-222">
                    <label for="street_name" class="form__label">Street name</label>
                    <input id="street_name" class="form__input" type="text" name="event_street_name"
                           placeholder="Pocztowa Street">
                    <label for="street_number" class="form__label">Street number</label>
                    <input id="street_number" class="form__input" type="text" name="event_street_number"
                           placeholder="1">
                </label>
            </div>
<!--            <div class="form__group">-->
...
<!--            </div>-->
            <div class="form__group">
                <label class="form__label" for="event_date">Date</label>
